Per il lato front-end (client) è stato utilizzato React.js, con l'aiuto di Redux per il controllo dello stato e Tailwind per stilizzare l'intero progetto.
